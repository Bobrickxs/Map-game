...
mapElement.addEventListener("click", (event) => {
    ...
    const distanceHint = getDistanceHind(distance);
    const distanceHintElement = document.getElementById("distance-hint");
    distanceHintElement.textContent = distanceHint;
    if (distance < 8)  {
        alert("В точку!")
    }
  });